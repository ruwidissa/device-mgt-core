...
CREATE INDEX fk_AM_DEVICE_SUBSCRIPTION_DM_DEVICE1_idx ON AP_DEVICE_SUBSCRIPTION (DM_DEVICE_ID ASC);
...
CREATE INDEX fk_AM_GROUP_SUBSCRIPTION_DM_GROUP1_idx ON AP_GROUP_SUBSCRIPTION (DM_GROUP_ID ASC);
