...
public class HttpDeviceTypeManagerServiceAndDeviceTypeGeneratorServceTest {
    ...
    private void createSampleDeviceTypeMetaDefinition()
        ...
        io.entgra.device.mgt.core.device.mgt.extensions.device.type.template.config.License license =
        ...
        List<io.entgra.device.mgt.core.device.mgt.common.Feature> features = new ArrayList<>();

        for (Feature feature : configurationFeatues) {
            io.entgra.device.mgt.core.device.mgt.common.Feature commonFeature = new io.entgra.device.mgt.core.device.mgt.common.Feature();
            ...
            io.entgra.device.mgt.core.device.mgt.common.Feature.MetadataEntry metadataEntry = new io.entgra.device.mgt.core.device.mgt
                    .common.Feature.MetadataEntry();
            metadataEntry.setId(1);
            metadataEntry.setValue(Utils.TEST_STRING);
            List<io.entgra.device.mgt.core.device.mgt.common.Feature.MetadataEntry> metadataEntries = new ArrayList<>();
