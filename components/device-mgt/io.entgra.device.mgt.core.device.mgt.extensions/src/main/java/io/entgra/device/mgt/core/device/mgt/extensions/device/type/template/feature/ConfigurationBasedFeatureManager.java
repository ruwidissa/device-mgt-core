...
public class ConfigurationBasedFeatureManager implements FeatureManager {
    ...
    public ConfigurationBasedFeatureManager(
            List<io.entgra.device.mgt.core.device.mgt.extensions.device.type.template.config.Feature> features) {
        for (io.entgra.device.mgt.core.device.mgt.extensions.device.type.template.config.Feature feature : features) {
