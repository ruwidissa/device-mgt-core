        ...
        if (entityClasses != null && !entityClasses.isEmpty()) {
            ...
            for (final String className : entityClasses) {
                ...
                List<Permission> resourcePermissions =
                        AccessController.doPrivileged(new PrivilegedAction<List<io.entgra.device.mgt.core.device.mgt.common.permission.mgt.Permission>>() {
                            public List<io.entgra.device.mgt.core.device.mgt.common.permission.mgt.Permission> run() {
                                Class<?> clazz;
